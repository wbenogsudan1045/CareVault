            ...
            <div class="col-md-4">
                <a href="medical_record.php">
                    <div class="card-dashboard h-100">
                        ...
                        <h5 class="fw-bold">Patient Health Records</h5>
                        <p class="text-muted">Review Patient past illnesses and current conditions at a glance.</p>
                    </div>
                </a>
            </div>
            <div class="col-md-4">
                <a href="medication.php">
                    <div class="card-dashboard h-100">
                        ...
                        <h5 class="fw-bold">Patient Medications</h5>
                        <p class="text-muted">Track Patient prescribed medications and intake schedule.</p>
                    </div>
                </a>
            </div>
            <div class="col-md-4">
                <a href="vaccination.php">
                    <div class="card-dashboard h-100">
                        ...
                        <h5 class="fw-bold">Patient Vaccinations</h5>
                        <p class="text-muted">View Patient vaccination status and upcoming booster schedules.</p>
                    </div>
                </a>
            </div>
        </div>
